...
// “роичный AND Ч поразр€дный минимум
...
// “роичный OR Ч поразр€дный максимум
...
// “роичный XOR Ч сумма ? обрезка до диапазона (-1, 0, +1)
...
// —равнение на равенство (всЄ ли биты одинаковы)
bool tryte::equals(const tryte& other) const {
    return raw() == other.raw();
}

// —равнение по значению (только если ты задашь пор€док тритов!)
